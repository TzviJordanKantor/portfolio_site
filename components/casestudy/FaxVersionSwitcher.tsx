...
const VERSIONS = [
  { id: "v1", href: "/work/fax/v1", label: "v1", note: "First build" },
  { id: "v2", href: "/work/fax/v2", label: "v2", note: "Current" },
] as const;

/**
 * Fixed pill bar for flipping between fax case-study iterations on localhost.
 * Comparison aid only — not shown on the canonical /work/fax page.
 */
export default function FaxVersionSwitcher({ current }: { current: "v1" | "v2" }) {
  return (
    <div
      style={{
        position: "fixed",
